...
A more comprehensive document for users is available at our official [Using Apache Maven](https://developers.google.com/appengine/docs/java/tools/maven) documentation site.

[Apache Maven](http://maven.apache.org/) is a software project management and comprehension tool.  It is capable of building war files for deployment into App Engine.  The App Engine Maven Plugin can further simplify development beyond what Maven provides.  It does so by enabling the following features in Maven.
...
A sample project is hosted on [github](https://github.com/GoogleCloudPlatform/appengine-guestbook-java)
